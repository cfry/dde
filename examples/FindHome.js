...
function replayPointsitr(points, times){
  ...
  for (var i = 0;i < points.length;i++){
    ...
    rt.push(Dexter.move_all_joints(points[i][0], points[i][1], points[i][2],  Math.round(points[i][3]),  Math.round(points[i][4])))
  }}
  return rt
}
...
function setNewHome(offsetPoint){
  ...
  rt.push(Dexter.move_all_joints(50000,50000,50000,50000,50000))
  rt.push(make_ins("F"))
...
new Job({name: "j1", robot: Robot.my_dex, keep_history: false,
         do_list: [	
              setKeepPossition(),
              make_ins("S", "J1BoundryHigh",410000),
        	  make_ins("S", "J1BoundryLow",-410000),
              make_ins("S", "J2BoundryLow",-210000),
              make_ins("S", "J2BoundryHigh",220000),
              make_ins("S", "J3BoundryLow",-520000),
              make_ins("S", "J3BoundryHigh",520000),
              make_ins("S", "J4BoundryLow",-330000),
              make_ins("S", "J4BoundryHigh",330000),
                //make_ins("w", 36,2000 ^ 5000),

                make_ins("S", "J5BoundryLow",-380000),
                make_ins("S", "J5BoundryHigh",380000),
                make_ins("S", "Acceleration",1),
                function(){return resolve_choice},
                make_ins("S", "MaxSpeed",240000),
                make_ins("S", "StartSpeed",3000),
                make_ins("S", "Acceleration",1),
