...
var txt = new function(){
	this.string_to_lines = function(string = "Hello World"){
    	let lines = []
        let spacing = .15
        let vert_spacing = 1.1
        let max_width = 0
        let line_num = 0
        	...
        	switch(string[i]){
               ...
               case "Z":
                ...
                case ".":
                    ...
                    max_width += txt.exlimation_max()+spacing
                	break
                ...
                case "!":
                	lines.push(Vector.add([max_width, -line_num*vert_spacing, 0], txt.exlimation()))
                    max_width += txt.exlimation_max()+spacing
                	break
                    
                case "'":
                	lines.push(Vector.add([max_width, -line_num*vert_spacing, 0], txt.apostrophe()))
                    max_width += txt.apostrophe_max()+spacing
                	break
                ...
                case '"':
                	lines.push(Vector.add([max_width, -line_num*vert_spacing, 0], txt.quote()))
                    max_width += txt.quote_max()+spacing
                	break
                ...
                case "$":
                	lines.push(Vector.add([max_width, -line_num*vert_spacing, 0], txt.dollor()))
                    max_width += txt.dollor_max()+spacing
                	break
                ...
                default:
                	dde_error('The character "' + string[i] + '" is not supported by txt.string_to_lines()')
            }
        }
        let elt
        let result = []
    ...
    this.exlimation_max = function(){return 0.0839491771521068}
	this.exlimation = function(){
    	return [
    ...
    this.apostrophe_max = function(){return 0.1670718827331825}
	this.apostrophe = function(){
    	return [
    ...
    this.quote_max = function(){return 0.5014326421759847}
	this.quote = function(){
    	return [
    ...
    this.dollor_max = function(){return 0.6682717266528755}
	this.dollor = function(){
    	return [
