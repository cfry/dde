new TestSuite("similar",
    ...
    ["similar(2.1, 2, 0.09)", "false", "tolerance too small to accomodate the difference"],
    ["similar(10, 9, 2)", "true"],
...
new TestSuite("obj_sys_js_fns_on_new_objects2",
	...
	["Object.entries(Root.test_thing)", '[["name", "test_thing"], ["color", "blue"], ["weight", 85], ["prototype", rootObject]]'],
