...
var Convert = new function(){
    ...
    this.angles_to_DCM = function(angles = [0, 0, 0], sequence = "XYZ"){
        ...
        warning("Convert.angles_to_DCM() has been depricated.</br>It will remain fully functional for the time being</br>but can be replaced with Vector.euler_angles_to_DCM()")
    ...
    this.DCM_to_angles = function(DCM, sequence = "XYZ"){
    	warning("Convert.DCM_to_angles() has been depricated.</br>It will remain fully functional for the time being</br>but can be replaced with Vector.DCM_to_euler_angles()")
        
    }
    
    this.quat_to_DCM = function(quaternion = [1, 0, 0, 0]){
    	warning("Convert.quat_to_DCM() has been depricated.</br>It will remain fully functional for the time being</br>but can be replaced with Vector.quaternion_to_DCM()")
    ...
    this.DCM_to_quat = function(DCM){
    	warning("Convert.DCM_to_quat() has been depricated.</br>It will remain fully functional for the time being</br>but can be replaced with Vector.DCM_to_quaternion()")
