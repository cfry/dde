...
http.createServer(function (req, res) {
  ...
  console.log("top of dde server request of pathname: " + q.pathname)
...
console.log("DDE server is now listening on port 80.") //dde4 new string printout
