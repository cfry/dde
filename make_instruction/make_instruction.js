...
var MakeInstruction = class MakeInstruction{
   ...
   /* obsoleted by add_robot_to_default_menu
        ...
        sim_pane_content_id.innerHTML =
            "<div style='background-color:#EEEEEE;margin-bottom:10px;'>" +
                "<div style='font-size:14px;font-weight:700;margin-left:50px;'>" +
                  "<a href='#' onclick='open_doc(make_instruction_pane_doc_id)'>" + "Make Instruction" +
                  "</a></div>" +
    ...
    /*obsoleted by robot_utils.js make_default_robot_menu_html
    ...
    static onchange_job_robot(){
       if(this.get_instruction_name_from_ui() == "new Job"){
           window[this.arg_name_to_dom_elt_id("robot")].value = default_robot_name() //mi_job_wrapper_robot_name_id.value
       }
    }
