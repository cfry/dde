...
Series.instances = [
    ...
    new Series({id:"series_robot_instruction_id", array: ["Dexter.calibrate_build_tables",
                                                          ...
                                                          "Control.if_any_errors", "Control.label", "Control.loop", "IO.out",
                                                          "IO.show_picture", "Control.include_job", "IO.show_video", "IO.take_picture",
                                                          "Control.send_to_job", "Control.sent_from_job", "Control.start_job", "Control.stop_job", "Control.suspend", "Control.sync_point",
                                                          "Control.unsuspend",
                                                          "Control.wait_until"],
