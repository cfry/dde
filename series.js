...
Series.instances = [
    ...
    new Series({id:"series_robot_instruction_id", array: ["Dexter.capture_ad", "Dexter.capture_points", "Dexter.cause_error",
                                                          ...
                                                          "Dexter.load_tables", "Dexter.move_home", "Dexter.move_all_joints", "Dexter.move_all_joints_relative",
                                                          ...
                                                          "Robot.error", "Robot.go_to", "Robot.if_any_errors", "Robot.get_page", "Robot.grab_robot_status",
                                                          "Robot.out", "Robot.send_to_job", "Robot.sent_from_job", "Robot.start_job", "Robot.stop", "Robot.suspend", "Robot.sync_point",
                                                          "Robot.wait_until", "debugger"],
