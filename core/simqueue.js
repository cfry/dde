...
var Simqueue = class Simqueue{
    ...
    done_with_instruction(){
        let cur_inst = this.current_instuction_in_queue()
    ...
    start_running_instruction_if_any(){
        if(this.is_queue_empty()) {
            ...
            let instruction_array = this.current_instuction_in_queue()
...
module.exports.Simqueue = Simqueue