...
var {shouldnt, value_to_percent_hex, little_hex_to_integer} = require("./utils")
...
globalThis.Servo = class Servo {
    ...
    static servo_set = function(servo_or_id=3, property_name, value, robot) {
        ...
        let hex = value_to_percent_hex(value, len)
    ...
    static interpret_job_get (job_or_data, reqid, reqaddr, reqlen) {
        ...
        let len = little_hex_to_integer(data.substr(5*3,2*3))
        ...
        let err = little_hex_to_integer(data.substr(8*3,1*3))
        let errmsg = ""
        ...
        let val = little_hex_to_integer(data.substr(9*3,len*3))
        //debugger
