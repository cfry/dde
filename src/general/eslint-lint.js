...
//import eslint from "eslint" //fry for eslint version 5
//commented out for dde4 because eslint is now globally defined in ready.js

function init_eslint_in_dde4() { //wrapping all this file in
    //this function made it possible to delay the eval of it
    //until all CodeMirror was defined.
    //and see last line of making this fn global!
    //but then I still have to CALL this fn after everything's loaded,
    //which I do at the bottom of Editor.init_editor

    (function (mod) {
        /* commenting this out from the sdt codemirror addon file format
          provided in CoreMirror 5 addons, made it possible to rollup dde4.
        ...
        var defaultConfig = {
            ...
            "rules": { //0 = "off" or "turn the rule off", 1 = warn, 2 = on, ie flag an error.
                ...
                "no-redeclare": 2,
                "no-regex-spaces": 2,
                //"no-reserved-keys": 0, //no longer in eslint
                ...
                //"generator-star": 0, //this rule removed from later versions of eslint
                ...
                //"space-after-keywords": [0, "always"], //no longer in eslint
                "space-before-blocks": [0, "always"],
                //"space-in-brackets": [0, "never"], //no longer in eslint
                ...
                //"spaced-line-comment": [0, "always"], //no longer in eslint
        ...
        function validator(text, options) {
            ...
            let errors = []
            try {
                errors = linter_inst.verify(text, config); //fry for eslint version 5
            }
            catch(err) {} //don't allow bugs in eslinter to break everything. fry jul 2. 2023
...
globalThis.init_eslint_in_dde4 = init_eslint_in_dde4
