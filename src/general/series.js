...
Series.instances = [
    ...
    new Series({id:"series_file_id",
        array:['DDEFile.append_to_file',
               'DDEFile.choose_file', 'DDEFile.choose_file_save_as', 'DDEFile.choose_file_to_upload',
               'DDEFile.choose_folder_to_upload', 'DDEFile.copy_file_async',
               'DDEFile.delete',  //'DDEFile.download', ???
               'DDEFile.download_file', 'DDEFile.dynamic_import',
               'DDEFile.edit_file',
               'DDEFile.file_exists', 'DDEFile.folder_listing',
               'DDEFile.get_page_async', 'DDEFile.insert_file_content','DDEFile.is_folder',
               'DDEFile.load_file', 'DDEFile.make_folder',
               'DDEFile.path_info',
               'DDEFile.read_file_async', 'DDEFile.read_file_part',
               'DDEFile.write_file_async',
               'DDE_DB.persistent_set', 'DDE_DB.persistent_get', 'DDE_DB.persistent_remove',
               'operating_system'],
        menu_insertion_string: 'DDEFile.load_file("foo.js")', menu_sel_start:0, menu_sel_end:18, sample: "DDEFile.load_files"}),
    ...
    new Series({id:"series_robot_instruction_id", array: ["Dexter.calibrate_build_tables",
                                                          ...
                                                          "Dexter.write_file", "Dexter.write_fpga",
                                                          ...
                                                          "IO.get_page", "Control.go_to", "IO.grab_robot_status",
                                                          ...
                                                          "Control.start_job", "Control.stop_job", "Control.suspend", "Control.sync_point",
                                                          "Control.unsuspend", "Control.wait_until",
                                                          "IO.out", "IO.show_picture", "IO.show_video", "IO.take_picture"],
    ...
    new Series({id:"series_oplet_id",
                array:["a","B", "b", "C", "c", "D", "d","E", "e","F","f","G","g","h","i","l",
                       "m","n","o","P", "p","R","S", "s","T", "t","W", "w","x","z"],
        menu_insertion_string:"S", menu_sel_start:true, menu_sel_end:null, sample:"S"}),
    new Series({id:"series_w_oplet_address_id",
        array: FPGA.w_oplet_address_names,
        menu_insertion_string: "FPGA.ACCELERATION_MAXSPEED", menu_sel_start:true, menu_sel_end:null, sample:"FPGA.ACCELERATION_MAXSPEED"}),
    new Series({id:"series_dexter_utility_id",
        //in_series_fn: function(str){return str.endsWith("props")},
        array: ["Dexter.dexter0.joint_angle","Dexter.dexter0.joint_angles","Dexter.dexter0.joint_xyz","Dexter.dexter0.joint_xyzs"],
        menu_insertion_string:"Dexter.dexter0.joint_angles()", menu_sel_start:0, menu_sel_end:-2, sample:"Dexter.dexter0.joint_angles()"}),
    ...
    new Series({id:"series_set_parameter_name_id",
          array: ["Acceleration",
                  "AngularSpeed", "AngularSpeedStartAndEnd", "AngularAceleration", "AxisCal",
                  "CartesianAcceleration",
                  "CartesianPivotAcceleration", "CartesianPivotEnd", "CartesianPivotSpeed",
                  "CartesianPivotSpeedEnd","CartesianPivotSpeedStart", "CartesianPivotStepSize",
                  "CartesianSpeed", "CartesianSpeedEnd", "CartesianSpeedStart", "CartesianStepSize",
                  "CommandedAngles", "CmdXor",
                  "EERoll","EESpan",
                  //"EndSpeed", not implemented
                  "EyeNumbers",
                  "GripperMotor",
                  "HomeOffset",
                  "Interpolation",
                  "J1BoundryHigh","J2BoundryHigh", "J3BoundryHigh", "J4BoundryHigh", "J5BoundryHigh",
                  "J1BoundryLow", "J2BoundryLow",  "J3BoundryLow",  "J4BoundryLow",  "J5BoundryLow",
                  "J1Force",      "J2Force",       "J3Force",       "J4Force",       "J5Force",
                  "J1Friction",   "J2Friction",    "J3Friction",    "J4Friction",    "J5Friction",
                  "J1_PID_P",     "J2_PID_P",      "J3_PID_P",      "J4_PID_P",      "J5_PID_P",
                  "JointStiffness",
                  "LinkLengths",
                  "Link1", "Link2", "Link3", "Link4", "Link5",
                  "MaxSpeed", "MaxTorque", "MotorMode",
                  "ServoSet", "ServoSetX", "ServoSet2X",
                  "StartSpeed",
                  "RawEncoderErrorLimits", "RawVelocityLimits",
                  "RebootServo", "RunFile"
                  ],
    ...
    new Series({id:"series_robot_name_id", array: Series.get_robot_name_array,
        menu_insertion_string: 'Dexter.dexter0',
