...
Series.instances = [
    ...
    new Series({id:"series_dexter_utility_id",
        //in_series_fn: function(str){return str.endsWith("props")},
        array: ["Robot.dexter0.joint_angle","Robot.dexter0.joint_angles","Robot.dexter0.joint_xyz","Robot.dexter0.joint_xyzs"],
        menu_insertion_string:"Robot.dexter0.joint_angles()", menu_sel_start:0, menu_sel_end:-2, sample:"Robot.dexter0.joint_angles()"}),
