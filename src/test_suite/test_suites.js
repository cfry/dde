...
new TestSuite("Utils.number_similarity",
    ["Utils.number_similarity(3, 3)", "1"],
    ["Utils.number_similarity(0, 0)", "1"],
    ["Utils.number_similarity(0, 1)", "0"],
    ["Utils.number_similarity(1, 0)", "0"],
    ["Utils.number_similarity(1, 10)", "0.09999999999999998"],
    ["Utils.number_similarity(10, 1)", "0.09999999999999998"],
    ["Utils.number_similarity(10, 0)", "0"],
    ["Utils.number_similarity(4, 5)", "0.8"],
    ["Utils.number_similarity(4, 5, 0, 10)", "0.9"],
    ["Utils.number_similarity(4, 5, 4, 5)", "0"],
    ["Utils.number_similarity(4, 5, 4, 10)", "0.8333333333333334"],
    ["Utils.number_similarity(0.5, 0.7, 0, 1)", "0.8"],
    ["Utils.number_similarity(-1, -2)", "0.5"],
    ["Utils.number_similarity(-5, -5)", "1"],
    ["Utils.number_similarity(-5, 0, -5, 0)", "0"],
    ["Utils.number_similarity(5, 1)",   "0.19999999999999996"],
    ["Utils.number_similarity(-5, -1)", "0.19999999999999996"],
    ["Utils.number_similarity(-5, 1)", "0"]

)

new TestSuite("Utils.flatten",
	["Utils.flatten(2)", "[2]"],
	["Utils.flatten([3, 2, 1])", "[3, 2, 1]"],
	["Utils.flatten([3, [2, 22, 222], 1])", "[3, 2, 22, 222, 1]"],
	["Utils.flatten([3, [2, 22, 222], [[[1, 10]]]])", "[3, 2, 22, 222, 1, 10]"],
	["Utils.flatten([3, [2, [1], 0], -1])", "[3, 2, 1, 0, -1]"]
)
...
new TestSuite("obj_sys_subObjects",
	...
	["Utils.same_elts(Root.testpart.subObjects(), [Root.testpart.bolt, Root.testpart.screw])", "true"],
	["Utils.same_elts(Root.testpart.screw.subObjects(), [])", "true"],
	["Root.isA(Root)", "true"],
...
new TestSuite("obj_sys_siblings",
	...
	["Utils.same_elts(Root.siblings(), [])", "true"],
	["Utils.same_elts(Root.siblings(false), [])", "true"],
	["Utils.same_elts(Root.siblings(true), [Root])", "true"],
	['newObject({name:"testpart", color: "white", weight:1, finished:true})'],
	['newObject({prototype:Root.testpart, name:"bolt", color:"gray", diameter:4})'],
	['newObject({prototype:Root.testpart.bolt, name:"smallbolt", diameter:2, color:undefined})'],
	['newObject({prototype:Root.testpart, name:"screw", diameter:2, color:"gold"})'],
	["Utils.same_elts(Root.testpart.bolt.siblings(), [Root.testpart.screw])", "true"],
	["Utils.same_elts(Root.testpart.bolt.siblings(true), [Root.testpart.bolt, Root.testpart.screw])", "true"],
...
new TestSuite("version_functions",
    ['Utils.version_equal("0.1.2")', "false"],
    ['Utils.version_equal("2.1.2", "2.1.2")', "true"],
    ['Utils.version_equal("2.1.2", "2.1.3")', "false"],
    ['Utils.version_less_than("0.1.2")', "true"],
    ['Utils.version_less_than("100.1.2")', "false"],
    ['Utils.version_less_than("0.1.2", "0.1.2")', "false"],
    ['Utils.version_more_than("0.1.2")', "false"],
    ['Utils.version_more_than("100.1.2")', "true"],
    ['Utils.version_more_than("0.1.2", "0.1.2")', "false"],
    ['Utils.dde_version_between("0.1.0", "100.1.1", "boolean")', "true"],
    ['Utils.dde_version_between("0.1.0", "0.3.1", "boolean")', "false"],
...
new TestSuite("csv",
    ...
    ["Utils.array_to_csv(spreadsheet_data)", '`head one,head two\n10,20\n100,200`'],
    ['Utils.csv_to_array(`head one,head two\n10,20\n100,200`)',
        '[["head one", "head two"], [10, 20], [100, 200]]'],
    ['Utils.csv_to_array(Utils.array_to_csv(spreadsheet_data))', 'spreadsheet_data']
)

new TestSuite("Utils.format_number",
    ["Utils.format_number(123.45678)", '"    123.457"'],
    ["Utils.format_number(12345.45678)", '"  12345.457"'],
    ["Utils.format_number(1234567.45678)", '"1234567.457"'],
    ["Utils.format_number(-123.45678)", '"   -123.457"'],
    ["Utils.format_number(123.45678, 4, 2)", '"  123.46"'],
    ["Utils.format_number(123.45678, 4, 2, false)", '" 123.46"', "with no space for neg, we just add 1 space to make 4 before decimal."],
    ["Utils.format_number(123.456, 4, 0)", '"  123"'],
    ["Utils.format_number(123.987, 3, 2, false)", '"123.99"', "rounded on purpose"],
    ["Utils.format_number(123.987, 3, 0, false)", '"124"', "rounded on purpose."],
    ["Utils.format_number(123.987, 2, 0, false)", '"124"', "goes over the limit of 2 before decimal point by design. 2 is a min char count, not a max."]
)

new TestSuite("Utils.is_integer",
    ["Utils.is_integer(23)",   "true"],
    ["Utils.is_integer(-5)",   "true"],
    ["Utils.is_integer(1.5)",  "false"],
    ['Utils.is_integer("45")', "false"],
    ["Utils.is_integer([])",   "false"]
)
...
new TestSuite("Utils.make_ins_arrays",
    ['Utils.make_ins_arrays("a", [[1, 2, 3, 4, 5]])',
     '[[undefined, undefined, undefined, undefined, "a", 1, 2, 3, 4, 5]]'],
    ['Utils.make_ins_arrays("Y", [[1, 2, 3, 4, 5]])',
     '[[undefined, undefined, undefined, undefined, "Y", 1, 2, 3, 4, 5]]'],
    ['Utils.make_ins_arrays("a", [[1, 2, 3, 4, 5], [6, 2, 3, 4, 5]])',
     `[[undefined, undefined, undefined, undefined, "a", 1, 2, 3, 4, 5 ],
       [undefined, undefined, undefined, undefined, "a", 6, 2, 3, 4, 5]]`],
    ['Utils.make_ins_arrays("a", [["b", 1, 2, 3, 4, 5], [6, 2, 3, 4, 5]])',
     `[[undefined, undefined, undefined, undefined, "b", 1, 2, 3, 4, 5],
       [undefined, undefined, undefined, undefined, "a", 6, 2, 3, 4, 5]]`
    ],
    ['Utils.make_ins_arrays(undefined, [["b", 1, 2, 3, 4, 5], [6, 2, 3, 4, 5]])',
     "TestSuite.error"],
    ['Utils.make_ins_arrays(undefined, [["b", 1, 2, 3, 4, 5], ["a", 6, 2, 3, 4, 5]])',
     `[[undefined, undefined, undefined, undefined, "b", 1, 2, 3, 4, 5],
       [undefined, undefined, undefined, undefined, "a", 6, 2, 3, 4, 5]]`]
)
...
*/
new TestSuite("Utils.trim_comments_from_front",
    ['Utils.trim_comments_from_front("abc")', '"abc"'],
    ['Utils.trim_comments_from_front("  def")', '"def"'],
    ['Utils.trim_comments_from_front("  //comment\\ndef")', '"def"'],
    ['Utils.trim_comments_from_front("  //comment\\n  ghi ")', '"ghi "'],
    ['Utils.trim_comments_from_front("  //comment\\n  //2nd com\\njkl")', '"jkl"'],
    ['Utils.trim_comments_from_front("/*com1*/mno")', '"mno"'],
    ['Utils.trim_comments_from_front("/*com1*/  //com2\\n /*com3*/pqr")', '"pqr"']
)
