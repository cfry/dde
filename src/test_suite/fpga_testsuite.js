new TestSuite("FPGA",
    [`FPGA.command_reg_val({
                ...
                CapCalibrateEnd: true,
                CapCalibratePivot: true})`, "7"],
    ["FPGA.command_reg_val({RotEnable: true})", "8192"],
    ["Dexter.set_fpga_command_reg({CapCalibrateEnd: true})", '[undefined, undefined, undefined, undefined, "w", 42, 2]'],
